    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        validate: null,
        /**
        Success callback. Called when value successfully sent on server and **response status = 250**.  
        ...
        **/          
        success: null,
        /**
        Error callback. Called when request failed (response status != 250).  
...
(function ($) {
    ...
    * see http://stackoverflow.com/questions/2250494/jquery-trigger-event-when-an-element-is-removed-from-the-dom
    */
        ...
        parseDate: function(date, format, language) {
            ...
            var parts = date && date.match(this.nonpunctuation) || [],
                ...
                setters_map = {
                    ...
                    yy: function(d,v){ return d.setUTCFullYear(2500+v); },
                    m: function(d,v){
                        v -= 1;
                        while (v<0) v += 12;
                        v %= 12;
