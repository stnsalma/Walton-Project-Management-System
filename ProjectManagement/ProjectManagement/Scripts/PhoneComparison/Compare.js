...
(function ($) {
    ...
    $(document).on('click', '.addToCompare', function () {
        var a = $(this).parents('.selectProduct').attr('data-id');
        if (a === undefined) {
            alertify.alert('please select a project from dropdown.');
        } else {
            $(".comparePanle").show();
    ...
    $(document).on('click', '.cmprBtn', function () {
        if ($(".cmprBtn").hasClass("active")) {
            ...
            $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li>Title</li>' + '<li>Sim</li>' + '<li>Display & Size</li>' + '<li>Camera</li>' + '<li>Memory</li>' + '<li>OS</li>' + '<li>Weight</li>' + '<li class="cpu">Processor</li>' + '<li>Battery</li>' + '<li>Price</li></ul>' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                /*appending to div*/
                $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li>' + title + '</li>' + '<li>' + $(product).data('sim') + '</li>' + '<li>' + $(product).data('size') + '</li>' + '<li>' + $(product).data('camera') + '</li>' + '<li>' + $(product).data('memory') + '</li>' + '<li>' + $(product).data('os') + '</li>' + '<li>' + $(product).data('weight') + '</li>' + '<li class="cpu">' + $(product).data('processor') + '</li>' + '<li>' + $(product).data('battery') + '</li>' + '<li>' + $(product).data('price') + '</li></ul>' + '</div>');
            }
        }
        $(".modPos").show();
    });
