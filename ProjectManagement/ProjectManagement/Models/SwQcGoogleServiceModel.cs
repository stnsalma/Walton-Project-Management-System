...
{
    public class FilesDetailForGoogleService
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcGoogleServiceModel
    {
        public SwQcGoogleServiceModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForGoogleService>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcGoogleServicesId { get; set; }
        ...
        public List<FilesDetailForGoogleService> FilesDetails { get; set; }
