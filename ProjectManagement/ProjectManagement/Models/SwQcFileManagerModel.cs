...
{
    public class FilesDetailForFileManager
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcFileManagerModel
    {
        public SwQcFileManagerModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForFileManager>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcFileManagerId { get; set; }
        ...
        public List<FilesDetailForFileManager> FilesDetails { get; set; }
