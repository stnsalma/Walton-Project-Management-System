...
{
    public class FilesDetailForShutDown
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcShutDownModel
    {
        public SwQcShutDownModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForShutDown>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcShutDownId { get; set; }
        ...
        public List<FilesDetailForShutDown> FilesDetails { get; set; }
