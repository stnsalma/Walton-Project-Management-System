...
{
    public class FilesDetailForMessage
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcMessageModel
    {
        public SwQcMessageModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForMessage>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcMassageId { get; set; }
        ...
        public List<FilesDetailForMessage> FilesDetails { get; set; }
