...
{
    public class FilesDetailForCall
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcCallSettingModel
    {
        public SwQcCallSettingModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForCall>();
        }
        public string EmployeeCode { get; set; }
        public long SwQcCallSettingId { get; set; }
        ...
        public List<FilesDetailForCall> FilesDetails { get; set; }
