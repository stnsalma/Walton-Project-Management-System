...
{
    public class FilesDetailForGame
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcGameModel
    {
        public SwQcGameModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForGame>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcGameId { get; set; }
        ...
        public List<FilesDetailForGame> FilesDetails { get; set; }
