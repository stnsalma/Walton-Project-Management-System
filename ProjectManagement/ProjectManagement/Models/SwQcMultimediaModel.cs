...
{
    public class FilesDetailForMultimedia
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcMultimediaModel
    {
        public SwQcMultimediaModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForMultimedia>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcMultimediaId { get; set; }
        ...
        public List<FilesDetailForMultimedia> FilesDetails { get; set; }
