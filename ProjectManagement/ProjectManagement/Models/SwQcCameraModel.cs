...
{
    public class FilesDetailForCamera
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcCameraModel
    {
        public SwQcCameraModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForCamera>();
        }
        public string EmployeeCode { get; set; }
        public long SwQcCameraId { get; set; }
        ...
        public List<FilesDetailForCamera> FilesDetails { get; set; }
