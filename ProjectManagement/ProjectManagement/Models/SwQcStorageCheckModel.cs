...
{
    public class FilesDetailForStorage
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcStorageCheckModel
    {
        public SwQcStorageCheckModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForStorage>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcStorageCheckId { get; set; }
        ...
        public List<FilesDetailForStorage> FilesDetails { get; set; }
