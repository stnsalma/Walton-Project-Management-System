...
{
    public class FilesDetailForTesting
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcTestingAppModel
    {
        public SwQcTestingAppModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForTesting>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcTestingAppId { get; set; }
        ...
        public List<FilesDetailForTesting> FilesDetails { get; set; }
