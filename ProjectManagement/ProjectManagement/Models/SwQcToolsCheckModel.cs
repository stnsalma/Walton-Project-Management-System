...
{
    public class FilesDetailForTools
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcToolsCheckModel
    {
        public SwQcToolsCheckModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForTools>();
        }
        ...
        public List<FilesDetailForTools> FilesDetails { get; set; }
