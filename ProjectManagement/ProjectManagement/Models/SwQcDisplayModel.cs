...
{
    public class FilesDetailForDisplay
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcDisplayModel
    {
        public SwQcDisplayModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForDisplay>();
        }
        ...
        public List<FilesDetailForDisplay> FilesDetails { get; set; }
