...
{
    public class FilesDetailForConnectivity
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcConnectivityModel
    {
        public SwQcConnectivityModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForConnectivity>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcConnectivityId { get; set; }
        ...
        public List<FilesDetailForConnectivity> FilesDetails { get; set; }
