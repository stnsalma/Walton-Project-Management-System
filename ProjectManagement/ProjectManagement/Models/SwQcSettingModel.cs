...
{
    public class FilesDetailForSetting
    {
        public string FilePath { get; set; }
        public string Extention { get; set; }
    }
    public class SwQcSettingModel
    {
        public SwQcSettingModel()
        {
            ScreenShotGetUrl1=new List<string>();
            FilesDetails = new List<FilesDetailForSetting>();
        }
        public string EmployeeCode { get; set; }
        public string UserFullName { get; set; }
        public long SwQcSettingsId { get; set; }
        ...
        public List<FilesDetailForSetting> FilesDetails { get; set; }
